...
func generateModel(table Table) string {
	...
	// 添加默认字段: remark, created_by, update_by, delete_by
	model += "    Remark    string    `gorm:\"type:varchar(255);\" json:\"remark\"`\n"
	model += "    CreatedBy string    `gorm:\"type:varchar(64);not null;\" json:\"created_by\"`\n"
	model += "    UpdatedBy string    `gorm:\"type:varchar(64);not null;\" json:\"updated_by\"`\n"
	model += "    DeletedBy string    `gorm:\"type:varchar(64);\" json:\"deleted_by\"`\n"
